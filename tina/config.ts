        ...
        collections: [
            ...
            },
            {
                ...
                fields: [
                    ...
                    { type: "string", name: "description", label: "SEO Description", required: true, ui: { component: "textarea" }, description: "Required search/social summary. This is metadata and is not automatically shown in the page header." },
            ...
            },
            {
                ...
                fields: [
                    ...
                    { type: "string", name: "title", label: "Page Title", required: true, isTitle: true, description: "Required page identity and browser title. Also becomes the visible heading when Headline is blank." },
                    { type: "string", name: "eyebrow", label: "Optional Eyebrow" },
                    { type: "string", name: "headline", label: "Optional Display Headline", description: "Leave blank to use Page Title as the visible heading." },
                    { type: "string", name: "description", label: "SEO Description", required: true, ui: { component: "textarea" }, description: "Required search/social summary. It is not automatically shown in the visible page header." },
            ...
            },
            {
                ...
                fields: [
                    ...
                    { type: "string", name: "description", label: "Optional Header Description", ui: { component: "textarea" }, description: "Optional supporting copy shown below the page title." },
                    { type: "string", name: "eyebrow", label: "Eyebrow" },
